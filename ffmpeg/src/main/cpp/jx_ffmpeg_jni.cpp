...
Java_com_cb_ffmpeg_jniinterface_FFmpegBridge_prepareJXFFmpegEncoder(JNIEnv *env,
                                                                                        jclass type,
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_cb_ffmpeg_jniinterface_FFmpegBridge_encodeFrame2H264(JNIEnv *env,
                                                                                  jclass type,
                                                                                  jbyteArray data_) {
...
Java_com_cb_ffmpeg_jniinterface_FFmpegBridge_getFFmpegConfig(JNIEnv *env,
                                                                                 jclass type) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_cb_ffmpeg_jniinterface_FFmpegBridge_encodeFrame2AAC(JNIEnv *env,
                                                                                 jclass type,
                                                                                 jbyteArray data_) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_cb_ffmpeg_jniinterface_FFmpegBridge_recordEnd(JNIEnv *env,
                                                                           jclass type) {
...
Java_com_cb_ffmpeg_jniinterface_FFmpegBridge_nativeRelease(JNIEnv *env,
                                                                               jclass type) {
