...
Java_com_cb_ffmpeg_jniinterface_FFmpegBridge_jxCMDRun(JNIEnv *env, jclass type,
...
Java_com_cb_ffmpeg_jniinterface_FFmpegBridge_initJXFFmpeg(JNIEnv *env, jclass type,
        jboolean debug,
jstring logUrl_);
